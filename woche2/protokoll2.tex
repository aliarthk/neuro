...
\caption{Ableitung eines extrazellulär abgeleitetem Aktionspotential nach anteriorer Reizung: In der Abbildung ist in Grün der Verlauf einer extrazellulären differentiellen Ableitung zu sehen.  Die Amplitude des identifizierten Aktionspotential beträgt $0,350-(-0,07)=0,42 mV$ und die Dauer $1,521/2 \approx 0,761 ms$ }
\label{ant}
\end{figure}

\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{aufgabe2/p4_2.png}}
\caption{Ableitung eines extrazellulär abgeleitetem Aktionspotential nach posteriorer Reizung: In der Abbildung ist in Grün der Verlauf einer extrazellulären differentiellen Ableitung zu sehen.  Die Amplitude des identifizierten Aktionspotential beträgt $0,0413-(-0,0036)=0,45 mV$ und die Dauer $2,432/2 \approx 1,216 ms$ }
\label{post}
\end{figure}

In \ref{ant} ist beispielhaft ein die Ableitung eines Aktionspotentials nach anteriorer Reizung zu sehen. Es ist klar zu erkennen, dass die Kurve erst steigt und dann fällt. Handelt es sich um eine posteriore Reizung \ref{post} so Fällt die Kurve zuerst und steigt danach.
...
\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{aufgabe3/g1_2.png}}
...
\section{Diskussion}
Keine klare Meidereaktion evtl weil Wurm "{}müde"{} da am Vormittag schon verwendet für versuche oä
