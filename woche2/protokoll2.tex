...
\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=0.7\textwidth]{bauchmark-laengs}\hspace*{4mm}\includegraphics[width=0.35\textwidth]{bauchmark-quer}}
\makebox[\textwidth][c]{}
...
Das Versuchstier wird in der Wurmplatte fixiert (s. Versuchsaufbau) und ebenfalls mit einem stumpfen Gegenstand je fünf mal am anterioren und posterioren Ende gereizt. Der Moment des Reizes wurde mit einem Keyboardmarker in Spike2 festgehalten. Zwischen zwei Reizen wurden dem Regenwurm je mindestens 30 Sekunden Ruhe gewährt.
